...
- Floor Irregularity (0–1, default 0) adds smooth local bumps independently of broad elevation. With elevation enabled the detail amplitude respects the remaining slope budget. Zero preserves the previous surface. Verified 12,794 direct Play Mode controller samples at maximum detail with elevation both off/on, without blocked movement or floor-height failures.
