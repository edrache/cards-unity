...
{
    /// <summary>
    /// Stores one immutable resolved-note or rest step before timeline expansion.
    /// </summary>
    public readonly struct PatternStep : IEquatable<PatternStep>
    {
        ...
        /// <summary>
        /// Gets the canonical rest value. The default <see cref="PatternStep"/> is also a rest.
        /// </summary>
        public static PatternStep Rest => default;
        ...
        public bool TryGetNote(out Note resolvedNote)
        {
            resolvedNote = note;
            return hasNote;
        }

        public bool Equals(PatternStep other)
        {
        ...
        {
            return obj is PatternStep other && Equals(other);
        }
        ...
        public static bool operator ==(PatternStep left, PatternStep right)
        {
